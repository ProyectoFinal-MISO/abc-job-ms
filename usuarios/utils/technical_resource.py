...
def TechnicalResourceDelete(technical_resource_id):
    try:
        AcademicInformationDelete(technical_resource_id)
        ProfessionalExperienceDelete(technical_resource_id)
        AditionalInformationDelete(technical_resource_id)

        technical_resource = TechnicalResource.query.filter_by(id = technical_resource_id).first()
        if technical_resource is None:
            return Response(status=404)
        db.session.delete(technical_resource)
        db.session.commit()
...
def TechnicalResourceProgrammingLanguagesDelete(technical_resource_id):
    try:
        tr_programming_languages = TechnicalResourceProgrammingLanguages.query.filter_by(technicalResourceId = technical_resource_id).all()
        for programming_language in tr_programming_languages:
...
def TechnicalResourceLanguagesDelete(technical_resource_id):
    try:
...
def TechnicalResourcePersonalSkillsDelete(technical_resource_id):
    try:
