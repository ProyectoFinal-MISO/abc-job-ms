...
from vistas.vistas import VistaUsuarioValidate, VistaUsuarios, VistasLogIn, VistaSignIn, VistaUsuario, VistaUsuarioSesion
...
api.add_resource(VistaUsuarios, '/users/<string:type_query>')
